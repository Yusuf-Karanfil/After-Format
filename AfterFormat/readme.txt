...
----------------------------------------------------------------
  ...
  [4] >>> 1_surucuden_once.bat <<< dosyasina çift tikla
      ...
      - Chrome kurulur
      - Varsayilan tarayici ayarini sonra elle yap:
        Ayarlar > Uygulamalar > Varsayilan uygulamalar > Chrome
...
----------------------------------------------------------------
  ...
  > WINDOWS DEFENDER
    Scriptlerden bagimsiz, ayri klasorde yonetilir:
    Defender Ac-Kapat\defender_kapat.bat  — kapatir
    Defender Ac-Kapat\defender_ac.bat     — yeniden acar
    (Her ikisi de cift tik + yonetici izni ile calisir.)
